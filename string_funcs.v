    ...
    (Ssequence
      (Swhile
        ...
        (Ssequence
          (Sassign
            (Ederef
              (Ebinop Oadd (Etempvar _dst (tptr tschar)) (Etempvar _i tuint)
                (tptr tschar)) tschar) (Etempvar _c tschar))
          (Ssequence
            (Sset _i
              (Ebinop Oadd (Etempvar _i tuint) (Econst_int (Int.repr 1) tint)
                tuint))
              ...
              (Ecast
                (Ederef
                  (Ebinop Oadd (Etempvar _src (tptr tschar))
                    (Etempvar _i tuint) (tptr tschar)) tschar) tschar)))))
...
((___builtin_fabs,
 ...
 (___builtin_write32_reversed,
   Gfun(External (EF_builtin ___builtin_write32_reversed
     ...
     tvoid cc_default)) :: (_my_strlen, Gfun(Internal f_my_strlen)) ::
 (_my_strcpy, Gfun(Internal f_my_strcpy)) :: nil);
prog_main := _main
|}.
